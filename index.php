 ...
 <script type="application/ld+json">
{
  ...
  * {
  ...
  .hidden:hover,
  .menu-desktop ul li a:hover+.hidden {
      display: block
  }
  ...
  .menu-responsive .hamburger:active,
  .menu-responsive .hamburger:focus,
...
opacity:0;
  ...
  .center .otros .secundarios {
     ...
     .otros .secundarios .medio .icon{
      ...
      .center .otros .secundarios .medio {
      position: absolute;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
 ...
 display: block;
  ...
  .formulario .options #status {
      ...
      padding: 7px;
      width: 45%;
      background: url(/img/arrow-down2-56.png) right no-repeat #fff;
      font-family: 'Open Sans';
      font-size: 14px;
...
<amp-video width="1920" height="800" src="https://beeinsured.co/img/carrousel/video-responsive.mp4"
    ...
    <div fallback>
      <p>Your browser doesn't support HTML5 video.</p>
        ...
        <a href="#">
            <amp-img src="img/carrousel/new-service-1-mobile.jpg" width="1920" height="900" layout="responsive" alt="another sample image"></amp-img>
        </a>
        <a href="#">
            <amp-img src="img/carrousel/new-service-2-mobile.jpg" width="1920" height="900" layout="responsive" alt="and another sample image"></amp-img>
        </a>
         <a href="#">
            <amp-img src="img/carrousel/new-service-4-mobile.jpg" width="1920" height="900" layout="responsive" alt="and another sample image"></amp-img>
        </a>
        <a href="https://beeinsured.co/services/certificates">
            <amp-img src="img/carrousel/new-service-3-mobile.jpg" width="1920" height="900" layout="responsive" alt="Get your Insurance Certificate" title="Insurance Certificate"></amp-img>
        </a>
         <a href="#">
            <amp-img src="img/carrousel/new-service-5-mobile.jpg" width="1920" height="900" layout="responsive" alt="and another sample image"></amp-img>
        </a>
    </amp-carousel>
