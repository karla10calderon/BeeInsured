...
<?php include('../menu.php');?>
    ...
    <div class="title-section">
            <h1>When You May Need General Liability Insurance? 
                <amp-img src="../img/icon.png" width="35" height="35" alt="#" title="#"></amp-img>
         </h1></div>
    <ol class="breadcrumbs">
        <li><a href="/index">Home /&nbsp;</a></li>
        <li><a href="/blog">Blog /&nbsp;</a></li>
        <li><a href="../blogs/4-tips-save-money.php" class="active">When You May Need General Liability Insurance?</a></li>
    </ol>


<!--NOTA-->
      <div class="blog">
 <amp-img src="../img/blog/When-You-Need-General-Liability-Insurance.jpg" width="1680" height="370" layout="responsive" title="#"></amp-img>
  <div class="texto">
                <h2>When You May Need General Liability Insurance?</h2><br>
