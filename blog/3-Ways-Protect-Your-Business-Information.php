...
<?php include('../menu.php');?>
    ...
    <div class="title-section">
            <h1>3 Ways to Protect Your Business Information 
                <amp-img src="../img/icon.png" width="35" height="35" alt="#" title="#"></amp-img>
         </h1></div>
    <ol class="breadcrumbs">
        <li><a href="/index">Home /&nbsp;</a></li>
        <li><a href="/blog">Blog /&nbsp;</a></li>
        <li><a href="/blog" class="active">3 Ways to Protect Your Business Information</a></li>
    </ol>


<!--NOTA-->
      <div class="blog">
 <amp-img src="../img/blog/3-way-proyect-your-business-information.jpg" width="1680" height="370" layout="responsive" title="#"></amp-img>
  <div class="texto">
                <h2>3 Ways To Protect Your Business Information</h2><br>
