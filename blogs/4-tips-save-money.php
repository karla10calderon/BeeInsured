...
<?php include('../menu.php');?>
    ...
    <div class="title-section">
            <h1>4 tips to Save Money &#127;
                <amp-img src="../img/icon.png" width="35" height="35" alt="#" title="#"></amp-img>
         </h1></div>
    <ol class="breadcrumbs">
        <li><a href="/index">Home /</a></li>
        <li><a href="/blog">Blog /</a></li>
        <li><a href="../blogs/4-tips-save-money.php" class="active">4 tips to Save Money</a></li>
    </ol>


<!--NOTA-->
      <div class="blog">
 <amp-img src="../img/blog/4-tips-save-money.jpg" width="1680" height="370" layout="responsive" title="#"></amp-img>
  <div class="texto">
                <h2>4 tips to Save Money</h2><br>
