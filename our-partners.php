...
<meta itemprop="image" content="https://www.beeinsured.co/img/Logo.png"><!-- Twitter Card tags -->
    ...
    <meta name="twitter:site" content="Bee Insured Partners">
...
</amp-user-notification><!--SEGUMIENTO DE ANALYTICS --><amp-analytics type="googleanalytics"><script type="application/json">{"vars":{"account":"UA-122019596-1"},"triggers":{"trackPageview":{"on":"visible","request":"pageview"}}}</script></amp-analytics>
...
<div id="marker"><amp-position-observer on="enter:hideAnim.start; exit:showAnim.start" layout="nodisplay"></amp-position-observer></div><?php include('menu.php');?><div class="title-section"><h1>Our Partners</h1></div><ol class="breadcrumbs"><li><a href="https://beeinsured.co/index">Home /&nbsp;</a></li><li><a href="https://beeinsured.co/about-us">About Us /&nbsp;</a></li><li><a href="https://beeinsured.co/our-partners" class="active">Our Partners</a></li></ol><div class="our-services"><h2>We work hard to offer you<br>the lower rate on your policy</h2></div>
    
    <amp-carousel width="1260" height="320" layout="responsive" type="slides" autoplay delay="2000">
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-1.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-2.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-3.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-4.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-5.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-6.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-7.png" width="1260" height="320" layout="responsive" ></amp-img>
        <amp-img src="https://beeinsured.co/img/carrousel/partners/partners-8.png" width="1260" height="320" layout="responsive" ></amp-img>    </amp-carousel>
    <div class="center">
    
    <amp-img src="https://beeinsured.co/img/our-partners.png" width="1260" height="320" alt="#" title="#" layout="responsive"></amp-img>
