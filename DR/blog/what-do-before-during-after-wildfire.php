...
<?php include('../menu.php');?>
    ...
    <div class="title-section">
            <h1>What to do before, during and after a wildfire 
                <amp-img src="../img/icon.png" width="35" height="35" alt="#" title="#"></amp-img>
         </h1></div>
    <ol class="breadcrumbs">
        <li><a href="/index">Home /&nbsp;</a></li>
        <li><a href="/blog">Blog /&nbsp;</a></li>
        <li><a href="../blogs/what-do-before-during-after-wildfire.php" class="active">What to do before, during and after a wildfire</a></li>
    </ol>


<!--NOTA-->
      <div class="blog">
 <amp-img src="../img/blog/What-do-before-during-after-wildfire" width="1680" height="370" layout="responsive" title="#"></amp-img>
  <div class="texto">
                <h2>What to do before, during and after a wildfire</h2><br>
