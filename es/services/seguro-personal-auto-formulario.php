...
<div id="marker">
  ...
  <?php include('../menu.php');?>
     <div class="title-section">
            <h1>Formulario Seguro de auto personal &#127;
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/personal-lines.php">Seguros personales /</a></li>
        <li><a href="/services/personal-auto.php">Seguro de auto personal </a></li>
         <li><a href="/services/personal-auto.php" class="active">Formulario Seguro de auto personal </a></li>
    </ol>

    <div class="info">
        <amp-img src="../../es/img/services/auto-personal.png" width="126" height="126"  alt="#" title="#"></amp-img>
 ...
 <!--Certificates Quote-->
    ...
    <fieldset>
      ...
      <br>
        <div class="options">
            <select name=" ¿Ha tenido multas o accidentes en los últimos 6 meses?" id="status">
                <option value="Si">Si</option>
                <option value="No">No</option>
           </select> 
           <label for="
¿Ha tenido multas o accidentes en los últimos 6 meses?"
      class="opt"> ¿Ha tenido multas o accidentes en los últimos 6 meses?</label>   
        </div>
      <label>
        <input type="text"
          name="¿Cuántos conductores?"
          placeholder="¿Cuántos conductores?"
          >
      </label>
      <br>
      <div class="options">
            <select name="¿Están en la póliza actual?" id="status">
                <option value="Si">Si</option>
                <option value="No">No</option>
           </select> 
           <label for="¿Están en la póliza actual?"
      class="opt">¿Están en la póliza actual?</label>   
        </div>
      <br>
      <input type="submit"
        value="Enviar">
