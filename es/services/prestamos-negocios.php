...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    <div class="title-section">
            <h1>Préstamos para pequeña y mediana empresa &#127;
        ...
        <div class="box">
         <!--    <div class="son">
            ...
            <div class="son">
                ...
                <h2>Beneficios</h2><br>
                <p>
                <br>Inventario de compras
                <br>Remodelación/expansiones
                <br>Compra/reparación de equipos 
                <br>Inicio de un negocio</p>
            </div>
          <!--    <div class="son">
