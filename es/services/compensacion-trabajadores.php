...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    <div class="title-section">
            <h1>Seguro Compensación a los trabajadores 
  ...
  <amp-img src="../../es/img/services/compensacion-trabajadores.jpg" width="1680" height="570" layout="responsive" title="#"></amp-img>
    <div class="info">
       ...
       El seguro de compensación a los trabajadores puede pagar tres cosas cuando un empleado es lesionado en el trabajo:<br><br>
Facturas médicas<br>
Costos de recuperación<br>
Salarios parciales perdidos<br>
Si un empleado muere, la compensación de los trabajadores puede cubrir los costos funerarios y beneficios para la familia del trabajador. Dependiendo de las leyes del estado y los requisitos del contrato, usted puede necesitar esta póliza para cubrir empleados, contratistas, autónomos o incluso usted mismo.<br><br>

Compensación de trabajadores (anteriormente "compensación de obreros") surgió de un “Gran acuerdo" entre los propietarios de negocios y trabajadores. Los dueños de negocios estaban cansados de ser demandados por trabajadores lesionados. Los trabajadores estaban cansados de ser heridos.<br><br>

Pague los gastos médicos y los salarios de reemplazo cuando los empleados se lesionan en el trabajo.<br>
Cumplir con las leyes de compensación de trabajadores del estado.<br>
Pague por gastos legales si un empleado demanda por una lesión de trabajo que la póliza no cubre.<br><br>

La mayoría de los Estados requieren que los empleadores compren el seguro de compensación de trabajadores tan pronto como contraten a su primer empleado. Incluso cuando ese no es el caso, es inteligente tener este tipo de seguro, porque el costo de las lesiones en el lugar de trabajo es sustancial:<br><br>

Como las tasas de compensación de los trabajadores continúan aumentando, también lo hacen los costos de operación que disminuyen su capacidad de prosperar. Los factores más importantes a considerar en la colocación de cualquier negocio con una compañía de seguros son la fuerza, el manejo de las demandas, el servicio y el precio de la póliza. Al situar su negocio con una compañía con un precio seguro y competitivo, minimiza la posibilidad de reducir el personal y maximizar su potencial de crecimiento.<br><br>
<br></p>
       
    </div>
        
     
<?php include('../es-formulario.php');?>
