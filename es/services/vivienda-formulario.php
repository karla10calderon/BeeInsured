...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/homeowners.php">Seguros de vivienda </a></li>
       <li><a href="/services/homeowners-quote.php" class="active">Formulario Seguro de vivienda</a></li>
    </ol>
    <div class="info">
        <amp-img src="../../es/img/services/vivienda.png" width="126" height="126"  alt="#" title="#"></amp-img>
 ...
 <!--Certificates Quote-->
    ...
    <fieldset>
      ...
      <br>
        <label>
        <input type="text"
          name="Información de la casa"
          placeholder="Información de la casa"
          required>
      </label>
      <br>
       <label>
      ...
      <br>
       <div class="options">
            <select name="Tipo de propietario" id="status">
                <option value="Ocupación propietario">Ocupación propietario</option>
                <option value="Dueño rentero">Dueño rentero</option>
           </select> 
           <label for="Tipo de propietario"
      class="opt">Tipo de propietario</label>   
        </div>
      <br>
      <label>
        <input type="text"
          name="Propietario personal"
          placeholder="Propietario personal"
          required>
      </label>
      <br> 
      <label>
        <input type="text"
          name="Valor de la casa"
          placeholder="Valor de la casa"
          required>
      </label>
      <br>
       <label>
        <input type="text"
          name="Medidas de la casa (en pies cuadrados)"
          placeholder="Medidas de la casa (en pies cuadrados)"
          required>
      </label>
      <br>
     <div class="options">
            <select name="
¿Es dueño de la casa, o continua pagándola?" id="status">
                <option value="Dueño">Dueño</option>
                <option value="Pagando">Pagando</option>
           </select> 
           <label for="¿Es dueño de la casa, o continua pagándola?"
      class="opt">¿Es dueño de la casa, o continua pagándola?</label>   
        </div>
     
      <br>
       <label>
        <input type="text"
          name="Ha hecho modificaciones en la casa, si las ha hecho, especifique cuáles"
          placeholder="Ha hecho modificaciones en la casa, si las ha hecho, especifique cuáles"
         >
      </label>
      <br>
