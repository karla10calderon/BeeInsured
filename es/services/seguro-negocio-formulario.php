...
<div id="marker">
  ...
  <?php include('../menu.php');?>
     <div class="title-section">
            <h1>Formulario Seguros de negocios&#127;
    ...
    <div class="info">
        <amp-img src="../../es/img/services/seguros-negocios.png" width="126" height="126"  alt="#" title="#"></amp-img>
 ...
 <!--Business Loans Quote-->
    ...
    <fieldset>
      ...
      <label>
        <input type="text"
          name="Fecha de la última remodelación del inmueble"
          placeholder="Fecha de la última remodelación del inmueble"
          required>
      </label>
      <br>
     <label>
      ...
      <label>
        <input type="text"
          name="Valor de la propiedad y valor de la mercancía"
          placeholder="Valor de la propiedad y valor de la mercancía"
          required>
      </label>
      <br>
        <label>
        <input type="text"
          name="SQF del Edificio"
          placeholder="SQF del Edificio"
          required>
      </label>
      <br>
       <label>
      ...
      <br>
        <div class="options">
            <select name="Tipo de Construcción" id="status">
                <option value="Marco">Marco</option>
                <option value="Metal">Metal</option>
                <option value="Albañilería">Albañilería</option>
                <option value="Concreto">Concreto</option>
           </select> 
           <label for="Tipo de Construcción"
      class="opt">Tipo de Construcción</label>   
        </div>
      <br>
        <label>
        <input type="text"
          name="Tiempo en el Negocio"
          placeholder="Tiempo en el Negocio"
          required>
      </label>
      <br>
