...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/fianza.php" class="active">Fianza</a></li>
...
Diferentes necesidades de precaución son satisfacidas por diferentes clases de fianza (Bond). Bee Insured con muchos años de experiencia atendiendo contratistas y negocios, grandes y pequeños dándonos la completa comprensión de los contratos necesarios para ayudar a su empresa a crecer. <br><br>Le ofrecemos la fianza (Bond) más confiable y tenemos un historial probado de la colocación de fianza (Bond) para los propietarios de negocios y contratistas nuevos en todo tipo de trabajo de fianza (Bond) más difícil para el trabajo peligroso a los propietarios con inexperiencia en todo tipo de proyecto.
