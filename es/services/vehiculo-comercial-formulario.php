...
<div id="marker">
  ...
  <?php include('../menu.php');?>
     <div class="title-section">
            <h1>Vehículo comercial formulario
    ...
    <div class="info">
        <amp-img src="../../es/img/services/vehiculo-comercial.png" width="126" height="126"  alt="#" title="#"></amp-img>
 ...
 <!--Business Loans Quote-->
    ...
    <fieldset>
      ...
      <label>
        <input type="text"
          name="¿Qué es lo que transporta en el vehículo?"
          placeholder="¿Qué es lo que transporta en el vehículo?"
          required>
      </label>
      <br>
      <label>
      ...
      <br>
      <div class="options">
            <select name="¿Están incluidos en la póliza?" id="status">
                <option value="Si">Si</option>
                <option value="No">No</option>
           </select> 
           <label for="¿Están incluidos en la póliza?"
      class="opt">¿Están incluidos en la póliza?</label>   
        </div>
      <br>
      <input type="submit"
        value="Enviar">
