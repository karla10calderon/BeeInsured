...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    <div class="title-section">
            <h1>Formulario Seguro Compensación a los trabajadores&#127;
...
<div class="info">
        <amp-img src="../../es/img/services/compensacion-trabajadores.png" width="126" height="126"  alt="#" title="#"></amp-img>
    ...
    <fieldset>
      ...
      <br>
        ...
        <label>
            <input type="text"
            name="Asegurado?"
            placeholder="¿Actualmente está asegurado? Si la respuesta es sí, por favor indique su compañía actual de seguro"
           >
        </label>
        <br>
       <label>
            <input type="text"
            name="Número de Licencia de Contratista"
            placeholder="Número de Licencia de Contratista"
            required>
        </label>
        <br>
         <label>
