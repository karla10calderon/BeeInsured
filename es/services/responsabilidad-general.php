...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/responsabilidad-general" class="active">Seguro de Responsabilidad General </a></li>
  ...
  <amp-img src="../img/services/general-liabilty-banner.jpg" width="1680" height="570" layout="responsive" title="general liabily quote" alt="general liabily quote"></amp-img>
    <div class="info">
        ...
        El negocio es inherentemente riesgoso pero, la cobertura de responsabilidad de negocios protege contra muchos riesgos conocidos y desconocidos. La cobertura del seguro de responsabilidad civil general le protege a usted, a su negocio y a sus empleados de reclamaciones que impliquen lesiones corporales o daños a la propiedad, hasta los límites de su póliza. Las pólizas le protegen del gasto de los asentamientos extrajudiciales, litigios y juicios otorgados por los tribunales.
        </p>
