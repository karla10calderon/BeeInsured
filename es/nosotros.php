...
<!--WHAT MAKES US DIFFERENT?-->
 ...
 <amp-img amp-fx="fade-in-scroll" src="/img/about-us-49.png" width="3106" height="1192" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
  ...
  <div class="texto">
            ...
            <p>Bee Insured simplifica las estrategias de compra para los clientes. Nuestros agentes profesionales están plenamente informados en las operaciones de seguros de construcción y las relaciones con múltiples compañías de seguros. Bee Insured mantiene una ventaja competitiva en el mercado de seguros de una relación larga que le da a Bee Insured el acceso para ofrecer verdadero valor a usted, nuestro cliente.</p>
           </div>
        </div>
