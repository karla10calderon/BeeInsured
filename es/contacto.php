...
<?php include('menu.php');?>
  ...
  <div submit-error>
    ...
    <div class="hijo">
             <p class="section">¿Tiene una cita?<br>Encuéntrenos en nuestra ubicación</p>
        </div>
