...
<?php include('menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/nuestro-equipo.php" class="active">Equipo</a></li>
    </ol>
...
<!--Team MANAGEMENT-->
 ...
 <amp-img src="../es/img/equipo.jpg" width="250" height="250" alt="#" title=""></amp-img>
  <p class="name">Jair Rodríguez</p>
          ...
          <!--Team Accounting, Servicio al cliente and Underwriting -->
          <p class="section">
            Cuentas, servicio al cliente y aprobación.
          </p>
