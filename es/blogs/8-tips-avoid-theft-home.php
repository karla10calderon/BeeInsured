...
<?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="../blogs/8-tips-avoid-theft-home.php" class="active">8 tips to avoid theft at home</a></li>
    </ol>


<!--NOTA-->
      <div class="blog">
 <amp-img src="../img/blog/8-tips-avoid-theft-home.jpg" width="1680" height="370" layout="responsive" title="#"></amp-img>
  <div class="texto">
                <h2>8 tips to avoid theft at home</h2><br>
