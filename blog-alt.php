...
<!--BUSINESS LOANS-->
 ...
 <amp-img src="/img/blog/note-cover-1.png" width="940" height="570" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
            (max-width: 940px) 75vw, 1200px" layout="responsive"></amp-img>
  <div class="texto">
                <h2>3 Tips To Get More Customers
To Your Construction Company</h2><br>
...
<!--INSURANCE SERVICES-->
   <a href="#"><div class="blog reverse">
 <amp-img amp-fx="fade-in-scroll" src="/img/blog/note-cover.png" width="940" height="570" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
            (max-width: 940px) 75vw, 1200px" layout="responsive"></amp-img>
  <div class="texto">
                <h2>5 Common Dangers
In Workplace</h2><br>
...
<!--CERTIFICATES-->  
  <a href="#"><div class="blog">
 <amp-img amp-fx="fade-in-scroll" src="/img/blog/note-cover-1.png" width="940" height="570" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
            (max-width: 940px) 75vw, 1200px" layout="responsive"></amp-img>
  <div class="texto">
                <h2>3 Tips To Get More Customers
To Your Construction Company</h2><br>
