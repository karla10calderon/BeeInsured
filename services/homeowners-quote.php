...
<html amp>
  <head>
    ...
    <title>Homeowners Quote by Bee Insured</title>
    <link rel="icon" href="/img/favicon.ico" type="image/x-icon">
    <link rel="canonical" hreflang="en" href="http://beeinsured.com/services/homeowners-quote">
    <link rel="alternate" hreflang="es" href="http://beeinsured.com/es/services/vivienda-formulario">

    <meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1">
    <meta name="description" content="#">
    <meta name="keywords" content="Quotes for homeowners insurance in California">
...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/homeowners.php">Homeowners </a></li>
       <li><a href="/services/homeowners-quote.php" class="active">Homeowners Quote</a></li>
    </ol>
    <div class="info">
        <amp-img src="../img/services/homeowner.png" width="126" height="126"  alt="#" title="#"></amp-img>
<p>Tell us a little bit about your company. <strong>Start your quote</strong> by providing us with your contact information and the type of <strong>policy you are searching for</strong>. And one of our license agents will be in touch with you shortly with a full quote.</p></div>
 ...
 <!--Certificates Quote-->
    ...
    <fieldset>
      ...
      <br>
       <div class="options">
            <select name="Choose the owner type" id="status">
                <option value="Owner Ocupancy">Owner Ocupancy</option>
                <option value="Owner Renter">Owner Renter</option>
           </select> 
           <label for="Choose the owner type"
      class="opt">Choose the owner type</label>   
        </div>
      <br>
      <label>
        <input type="text"
      ...
      <br>
       <label>
        <input type="text"
          name="House dimensions (foot square)"
          placeholder="House dimensions (foot square)"
          required>
      </label>
      <br>
     <div class="options">
            <select name="Do you own the house, or are you paying?" id="status">
                <option value="Own">Own</option>
                <option value="Paying">Paying</option>
           </select> 
           <label for="Do you own the house, or are you paying?"
      class="opt">Do you own the house, or are you paying?</label>   
        </div>
     
      <br>
       <label>
        <input type="text"
          name="Some modification in the last months, if yes specify"
          placeholder="Some modification in the last months, if yes specify"
         >
      </label>
      <br>
