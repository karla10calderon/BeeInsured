...
<html amp>
  <head>
    ...
    <link rel="canonical" hreflang="en" href="http://beeinsured.com/services/personal-lines">
    <link rel="alternate" hreflang="es" href="http://beeinsured.com/es/services/seguros-personales">
...
<?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="../services/personal-lines.php" class="active">Personal Lines</a></li>
    </ol>
 ...
 <amp-img src="../img/services/personal-auto-baner.png" width="940" height="570" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
  ...
  <div class="texto">
             <amp-img src="../img/services/personal-auto.png" width="60" height="60"  alt="#" title="#"></amp-img>
                <h2>Personal Auto</h2><br>
            <p>All of the Insurance companies we represent provide a wide range of auto Insurance products at a fair price. Your price gets even better if you qualify for any of our available discounts.</p>
           </div>
        </div></a>
<!--INSURANCE SERVICES-->
 ...
 <amp-img amp-fx="fade-in-scroll" src="../img/services/homeowners-baner.png" width="940" height="570" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
  ...
  <div class="texto">
             <amp-img src="../img/services/homeowner.png" width="60" height="60"  alt="#" title="#"></amp-img>
                <h2>Homeowners</h2><br>
            <p>Homeowner insurance is a form of property insurance that covers losses and damages to an individual's house and to assets in the home.</p>
           </div>
        </div></a>
