...
<html amp>
  <head>
    ...
    <link rel="canonical" hreflang="en" href="https://beeinsured.co/services/personal-auto">
    <link rel="alternate" hreflang="es" href="https://beeinsured.co/es/services/personal-auto">

    <meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1">
    <meta name="description" content="#">
    <meta name="keywords" content="Car Insurance California, Auto insurance Fresno">
...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/personal-auto.php" class="active">Personal Auto </a></li>
       
    </ol>

  <amp-img src="../img/services/personal-auto-1-26.png" width="1680" height="570" layout="responsive" title="#"></amp-img>
    <div class="info">
        <p><strong>Auto Insurance</strong> isn't just a good thing to have to protect you financially in the case of an accident - in many states it's required.<br>
