...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/commerical-vehicle.php" class="active">Commercial Vehicle</a></li>
       
    </ol>

  <amp-img src="../img/services/commercial-vehicle-banner.jpg" width="1680" height="570" layout="responsive" title="#"></amp-img>
    <div class="info">
        <p>When you own a business, you have a lot to protect, and the right insurance coverage can be important to your continued success, that is why in <strong>Bee Insured</strong> we work hard to find the best in insurance with lower rates for your commercial vehicles.<br><br>

            <b>Coverage:</b> • Physical Damage • Cargo/Inland Marine • Commercial Auto • Commercial Auto-Mono • Commercial Auto-Truckers • Transportation • Truckers • Tracking.</p>
