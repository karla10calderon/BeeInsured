...
<html amp>
  <head>
    ...
    <link rel="canonical" hreflang="en" href="http://beeinsured.com/services/homeowners">
    <link rel="alternate" hreflang="es" href="http://beeinsured.com/es/services/vivienda">
...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/personal-lines">Personal Lines /</a></li>
        <li><a href="/services/homeowners" class="active">Homeowners </a></li>
  ...
  <amp-img src="../img/services/homeowners-banner.jpg" width="1680" height="570" layout="responsive" title="Homeowners insurance service" alt="Homeowners Insurance Service, get your quote"></amp-img>
    <div class="info">
        <p><strong>Homeowner insurance</strong> is a form of property insurance that covers losses and damages to an individual's house and to assets in the home.</p>
