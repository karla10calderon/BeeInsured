...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/workers-compensation" class="active">Workers Compensation </a></li>
       
    </ol>

  <amp-img src="../img/services/workers-compensation-1-26.jpg" width="1680" height="570" layout="responsive" title="#"></amp-img>
    <div class="info">
        <p><b>Workers Compensation Insurance</b> **Required by law in almost every state**<br><br>
