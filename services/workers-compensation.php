...
<html amp>
  <head>
   ...
   <title>Workers Compensation by Bee Insured</title>
    ...
    <link rel="canonical" hreflang="en" href="http://beeinsured.com/services/workers-compensation">
    <link rel="alternate" hreflang="es" href="http://beeinsured.com/es/services/compensacion-trabajadores">

    <meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1">
    <meta name="description" content="#">
    <meta name="keywords" content="workers compensation insurance california, workers compensation insurance rating bureau">
...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/workers-compensation.php" class="active">Workers Compensation </a></li>
       
    </ol>

  <amp-img src="../img/services/workers-compensation-1-26.jpg" width="1680" height="570" layout="responsive" title="#"></amp-img>
    <div class="info">
        <p><b>Workers Compensation Insurance</b> <i>**Required by law in almost every state**</i><br><br>

            <strong>Workers Compensation Insurance</strong> can pay for three things when an employee is injured at work: medical bills, recovery costs, and partial missed wages. If an employee dies, Workers' Comp can cover funeral costs and benefits to the worker's family. Depending on state laws and contract requirements, you may need this policy to cover employees, contractors, freelancers, or even yourself.<br><br>

            Workers' Comp (formerly "<strong>workman's comp</strong>") emerged from a "grand bargain" between business owners and workers. Business owners were tired of being sued by injured workers. Workers were tired of being injured.<br><br>

Pay for medical expenses and replacement wages when employees are injured at work.<br><br>
Comply with state Workers' Comp laws.
Pay for legal expenses if an employee sues over a work injury the policy doesn't cover.<br><br>

Most states require employers to buy Workers' Compensation Insurance as soon as they hire their first employee. Even when that's not the case, it's smart to have this policy, because the cost of workplace injuries is substantial:<br><br>

As Workers Compensations rates continue to rise, so do operating costs which diminish your ability to thrive. The most important factors to consider in placing any business with an insurance company is strength, claims handling, service and price of the policy. By placing your business with a secure and competitively-priced company, you minimize the possibility of staff reductions and maximize your growth potential.<br></p>
