...
<?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/insurance-services.php" class="active">Insurance Services</a></li>
    </ol>
    ...
    <div class="intro">
       ...
       <div class="box"><a href="/services/personal-lines.php">
            <div class="son">
                ...
                <h2>Personal Lines</h2><br>
                <p>It's not only about being insured. It's about enjoying life and being calm, because you're protected against any situation that could harm you or your family.</p>
            </div></a>
            <a href="/services/commercial-insurance.php"><div class="son">
                <amp-img src="/img/services/commercial-insurance.png" width="60" height="60" alt="#" title="#"></amp-img>
                <h2>Commercial Insurance</h2><br>
                <p>When you own a business, you have a lot to protect, and the right insurance coverage can be important to your continued success, thats why in Bee Insured we work hard to find the best in insurance with lower rates for your business.</p>
            </div></a>
