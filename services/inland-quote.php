...
<div id="marker">
  ...
  <?php include('../menu.php');?>
     <div class="title-section">
            <h1>Inland Marine Tool & Equipment Quote&#127;
    ...
    <ol class="breadcrumbs">
       ...
       <li><a href="/services/inland-marine-tool.php">Inland Marine Tool & Equipment /</a></li>
       <li><a href="/services/inland-quote.php" class="active">Inland Marine Tool & Equipment Quote</a></li>
    </ol>
    ...
    <fieldset>
      ...
      <br>
       <label>
        ...
        <p class="note">Equipment valued $1,500 & under needs to be covered as Misc. Tools</p>
      <br>
      <label>
        <input type="text"
