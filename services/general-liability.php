...
<html amp>
  <head>
    ...
    <link rel="canonical" hreflang="en" href="http://beeinsured.com/services/general-liability">
    <link rel="alternate" hreflang="es" href="http://beeinsured.com/es/services/responsabilidad-general">
...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/general-liability" class="active">General Liability </a></li>
  ...
  <amp-img src="../img/services/general-liabilty-banner.jpg" width="1680" height="570" layout="responsive" title="general liabily quote" alt="general liabily quote"></amp-img>
    <div class="info">
        <p>Every business needs to <strong>protect themselves from accidents or injuries</strong> that may occur on their business grounds.<br> <strong>General Liability insurance coverage</strong> can protect your business from these unexpected expenses, so it is essential that you understand what it does and doesn't cover.</p>
