...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
        ...
        <li><a href="/services/workers-compensation.php">Workers Compensation /</a></li>
        <li><a href="/services/workers-compensation.php" class="active">Workers Compensation Quote</a></li>
 ...
 <!--WORKERS COMPENSATION-->
    ...
    <fieldset>
      ...
      <br>
       ...
       <label>
            <input type="text"
            name="Contractor Lic Number"
            placeholder="Contractor Lic Number"
            required>
        </label>
        <br>
         <label>
