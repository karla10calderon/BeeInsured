...
<html amp>
  <head>
   ...
   <title>Commercial Vehicle Quote by Bee Insured</title>
    <link rel="icon" href="/img/favicon.ico" type="image/x-icon">
    <link rel="canonical" hreflang="en" href="http://beeinsured.com/services/commercial-vehicle-quote">
    <link rel="alternate" hreflang="es" href="http://beeinsured.com/es/services/vehiculo-comercial-formulario">

    <meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1">
    <meta name="description" content="We give you the best commercial vehicle.">
    <meta name="keywords" content="Quotes for commercial Vehicle Insurance California">
...
<div id="marker">
  ...
  <?php include('../menu.php');?>
    ...
    <ol class="breadcrumbs">
       ...
       <li><a href="/services/commercial-vehicle.php">Commercial Vehicle /</a></li>
       <li><a href="/services/commercial-vehicle-quote.php" class="active">Commercial Vehicle Quote</a></li>
    </ol>

    <div class="info">
        <amp-img src="../img/services/commercial-vehicle.png" width="126" height="126"  alt="#" title="#"></amp-img>
 ...
 <!--Business Loans Quote-->
    ...
    <fieldset>
      ...
      <label>
        <input type="text"
          name="What is carrying on the vehicle?"
          placeholder="What is carrying on the vehicle?"
          required>
      </label>
      <br>
      <label>
