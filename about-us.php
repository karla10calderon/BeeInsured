...
<html amp>
  <head>
    ...
    <link rel="canonical" lang="en" href="http://beeinsured.com/about-us">
...
Bee Insured focuses on the relationship between agents and customers, and ensuring customer satisfaction above all else. Bee Insured is a full-service insurance agency, able to handle customers personal and business insurance needs.</p>
           </div>
        </div>
<!--WHAT MAKES US DIFFERENT?-->
 ...
 <amp-img amp-fx="fade-in-scroll" src="/img/about-us-49.png" width="3106" height="1192" alt="#" title="#" sizes="(max-width: 1100px) 100vw, 
  ...
  <div class="texto">
            ...
            <p>Bee Insured simplifies shopping strategies for customers. Our professional agents are fully knowledgeable in the construction insurance trades, and multiple carrier relationships, Bee Insured maintains a competitive advantage in the insurance marketplace. It is the competitive advantages of these long-standing relationships which gives us the insight and the access to offer true value to you, our customer.</p>
           </div>
        </div>
